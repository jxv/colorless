...
colorless -l haskell -s HelloWorldPublic/spec.json -m Colorless.Examples.HelloWorld -n HelloWorld -d ./HelloWorldPublic/haskell-client -e client -a httpClient
...
colorless -l haskell -s HelloWorld -m Colorless.Examples.HelloWorld -n HelloWorld -d ./HelloWorld/haskell-client -e client -a httpClient
