...
import Fluid.Gen.Python.Conversion (conversion)
...
generateServer args = Gen.generate conversion args Set.empty (Gen.generateServer (\major -> "major_" <> show major <> ".py") "server.py" Server.gen ServerLatest.gen)
