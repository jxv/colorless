...
import Fluid.Gen.Scala.Conversion (conversion)
...
generateServer args = Gen.generate conversion args Set.empty (Gen.generateServer (\major -> "Major" <> show major <> ".scala") "Server.scala" Server.gen ServerLatest.gen)
