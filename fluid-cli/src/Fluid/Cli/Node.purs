...
import Fluid.Gen.Node.Conversion (conversion)
...
generateServer args = Gen.generate conversion args Set.empty (Gen.generateServer (\major -> "Major" <> show major <> ".js") "Server.js" Server.gen ServerLatest.gen)
