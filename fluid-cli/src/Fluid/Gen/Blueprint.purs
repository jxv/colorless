...
buildDepGraph :: Schema -> StrMap (Set Dep)
...
requiresRecursiveIndirection :: StrMap (Set Dep) -> Set DepTag -> TypeName -> Boolean
...
nameOfDependencyAux :: Dep -> Set DepTag -> Array TypeName -> Set TypeName
