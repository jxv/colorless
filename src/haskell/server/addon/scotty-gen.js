...
const gen = (s) => {
  return new Lines([
    ...
    '  -> C.Pull\n',
    '  -> Scotty.ScottyT e m ()\n',
    s.lowercaseName, '\'Scotty\'SendResponse _options _metaMiddleware _pull = Scotty.sendResponseSingleton _pull ', s.lowercaseName,'\'Version (', s.lowercaseName,'\'Handler _options _metaMiddleware)\n',
    '\n',
    s.lowercaseName, '\'Scotty\'GetSpec :: (Scotty.ScottyError e, R.MonadIO m) => C.Pull -> Scotty.ScottyT e m ()\n',
    s.lowercaseName, '\'Scotty\'GetSpec = Scotty.getSpec P.$ R.toJSON [', s.lowercaseName,'\'Spec]\n',
  ]);
};
